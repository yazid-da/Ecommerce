        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-9">
                    ...
                    <div class="hero__item set-bg" data-setbg="img/hero/mielbanner.jpg">
                        <div class="hero__text">
                            <span>Produits</span>
                            <h2>100% Bio <br />100% Organic</h2>
                            <p>Livraison gratuite à partir de 250 Dhs d'achats</p>
    ...
    <section class="categories">
        <div class="container">
            <div class="row">
                ...
                @foreach($categories as $categorie)    
                    <div class="col-lg-3">
                        <div class="categories__item set-bg" data-setbg="{{ asset('img/uploads/'.$categorie->image)}}">
                            <h5><a href="{{url('/produits/'.$categorie->id)}}">{{ $categorie->name }}</a></h5>
                        </div>
                    </div>
                @endforeach
                </div>
