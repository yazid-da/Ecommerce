            ...
            <!-- ============================================================== -->
                    <!-- Column -->
                        <div class="card">
                            <div class="card-body">
                            <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                                <h4 style="font-weight: 700;" class="page-title">Modifier un produit</h4>
                            </div><br>
                                <form action="{{ url('update-produit/'.$produit->id)}}" method="POST" enctype="multipart/form-data" class="form-horizontal form-material">
                                    @csrf
                                    @method('PUT')
                                    <div class="form-group mb-4">
                                        <label class="col-md-12 p-0">Designation*</label>
                                        <div class="col-md-12 border-bottom p-0">
                                            <input name="designation" type="text" value="{{ $produit->designation }}" class="form-control p-0 border-0"> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group mb-4">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <textarea name="description" rows="5" class="form-control p-0 border-0">{{ $produit->description }}</textarea>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="number" name="prix_uni" value="{{ $produit->prix_uni }}" min="0" step="0.01"> Mad</input>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        @if ($produit->image)
                                        <img src="{{ asset('img/uploads/'.$produit->image)}}" alt="Image Categorie">
                                        @endif
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="file" name="image" value="" class="form-control"></input>
                                        </div>
                                    </div><br>
                                    <div class="col-md-12">
                                        <label class="col-md-12 p-0">Image 2</label>
                                        @if ($produit->image2)
                                        <img src="{{ asset('img/uploads/'.$produit->image2)}}" alt="Image Categorie">
                                        @endif
                                        <div class="col-md-12 border-bottom p-0">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        @if ($produit->image)
                                        <img src="{{ asset('img/uploads/'.$produit->image3)}}" alt="Image Categorie">
                                        @endif
                                        <div class="col-md-12 border-bottom p-0">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="col-md-12 border-bottom p-0">
                                            <input type="number" value="{{ $produit->qte }}" name="qte" min="0"></input>
                                        </div>
                                    </div>
