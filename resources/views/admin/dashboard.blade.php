             ...
             <!-- Tableau d'utilisateur  -->
                ...
                <div class="page-breadcrumb bg-white">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        ...
                        <a href="{{ url('/dashboard/categories/#add-categorie')}}"><button class="addbutton" >Ajouter Categorie</button></a>
                        <a href="{{ url('/dashboard/categories')}}"><button class="addbutton" >Modifier</button></a>
                </div>
                ...
                <div class="page-breadcrumb bg-white">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                            ...
                            <thead>
                                    ...
                                    @foreach($produits as $produit)
                                        <tr>
                                            ...
                                            <td>{{ $produit->qte }}</td>
                                            <td><a href="#" style=" color : #f4a442;"> modifier </a><a href="#" style=" color : red;"> supprimer </a></td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                            </table>
                        ...
                        <a href="{{ url('/dashboard/produits')}}"><button class="addbutton" >Modifier</button></a>
                </div>
